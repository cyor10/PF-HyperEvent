        ...
        <div className='font-figtree'>
            <div className='ml-6 pt-3'>
                <div className='pt-3 flex h-10 bg-slate-50 items-center mb-4'>
                    ...
                    <input className='pl-1 leading-6 tracking-custom font-bold text-black w-60 h-10 text-2xl focus:outline-none' type='search' placeholder='Search for anything' onChange={(event) => handleChange('word', event.target.value)} value={orderFilters.word}></input>
                </div>
                ...
                <div className='flex h-10 bg-slate-50 items-center mb-2 mt-6'>
                    ...
                    <select className='appearance-none font-bold leading-6 tracking-custom text-black ml-5 w-60 h-10 text-2xl rounded focus:outline-none' value={orderFilters.city} onChange={(event) => handleChange('city', event.target.value)}>
            ...
            {reduxEvents.searchedEvents?.length !== 0 ?
                <div>
                    <div className='flex w-80 h-2 bg-black mt-8 mx-auto'></div>
