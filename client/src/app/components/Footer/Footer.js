...
export default function Footer() {
  ...
  return (name?.length > 0 || price?.length > 0 || pathname === "/payment/" || pathname === "/create_event" || pathname === "/create_event/form_step_1" || pathname === "/create_event/form_step_2" || pathname === "/create_event/form_step_3" || pathname === '/payment/success' || pathname === '/payment/error') ? null : (
