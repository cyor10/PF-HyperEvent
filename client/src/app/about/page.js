...
export default function About() {
  return (
    <div className='flex flex-col items-center justify-center min-h-screen mt-16 text-black pt-5'>
      <h2 className='text-5xl mt-3 mb-2 px-2 font-bold'>About us</h2>
      ...
      <h2 className="text-4xl mt-3 mb-2 px-2 font-bold	">Meet the team</h2>
